                                  ...
                                  onPressed: () {
                                    setState(() {
                                      if (myController.text != '' &&
                                        ...
                                        createColleges(
                                            myController.text, selectedItem,
                                            selectedItem1);
                                        print(availablecolleges.length);
                                      }
                                      else {
                                        Toast.show(
                                            "Please sellect all fields for accurate results.",
                                            context,
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              Padding(
                padding: EdgeInsets.all(10),
                child: Text(topColleges[index]['Institute Name'],
                  style: GoogleFonts.aBeeZee(
                      fontSize: 20, fontWeight: FontWeight.bold),),
              ),
              Padding(
                padding: EdgeInsets.all(10),
                child: Text(topColleges[index]['Branch Name'],
                  style: GoogleFonts.aBeeZee(
              ...
              Padding(
                padding: EdgeInsets.all(10),
                child: Text(
                  'Opening Rank- ' + topColleges[index]['Openning Rank'],
                  style: GoogleFonts.aBeeZee(
                      fontSize: 16, fontWeight: FontWeight.w300),),
              ),
              Padding(
                padding: EdgeInsets.all(10),
                child: Text(
                  'Closing Rank- ' + topColleges[index]['Closing Rank'],
                  style: GoogleFonts.aBeeZee(
                      fontSize: 16, fontWeight: FontWeight.w300),),
              ),
              SizedBox(
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              Padding(
                padding: EdgeInsets.all(10),
                child: Text(availablecolleges[index].b,
                  style: GoogleFonts.aBeeZee(
                      fontSize: 20, fontWeight: FontWeight.bold),),
              ),
              Padding(
                padding: EdgeInsets.all(10),
                child: Text(availablecolleges[index].c,
                  style: GoogleFonts.aBeeZee(
                      fontSize: 16, fontWeight: FontWeight.w300),),
              ),
              Padding(
                padding: EdgeInsets.all(10),
                child: Text('Opening Rank- ' + availablecolleges[index].g,
                  style: GoogleFonts.aBeeZee(
                      fontSize: 16, fontWeight: FontWeight.w300),),
              ),
              Padding(
                padding: EdgeInsets.all(10),
                child: Text('Closing Rank- ' + availablecolleges[index].h,
                  style: GoogleFonts.aBeeZee(
                      fontSize: 16, fontWeight: FontWeight.w300),),
              ),
              SizedBox(
